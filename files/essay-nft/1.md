...
> _✏️ The amount of serendipity that will occur in your life, your Luck Surface Area, is directly proportional to the degree to which you do something you're passionate about combined with the total number of people to whom this is effectively communicated. (1)_
...
> _🏃 Deliberate practice is "effortful in nature, with the main goal of personal improvement of performance rather than enjoyment, and is often performed without immediate reward." (2)_
...
We could connect the 3D Luck Surface Area model with related models, like the [P/PC balance](https://www.coachcarson.com/p-pc-balance/), the [flow channel](https://www.researchgate.net/figure/The-flow-channel-model-adapted-from-Csikszentmihalyi-1975_fig1_259998152), or the [adjacent possible](https://understandinginnovation.blog/2019/01/03/exploring-the-adjacent-possible-the-origin-of-good-ideas/).
